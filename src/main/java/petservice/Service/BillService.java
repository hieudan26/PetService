...
public interface BillService {
    ...
    List<BillEntity> getAllByUser(UserEntity user, Pageable pageable) throws Exception;
    BillEntity getByPet(PetEntity pet) throws Exception;
    List<BillEntity> getAllByPaymentDate(LocalDateTime time, Pageable pageable) throws Exception;
