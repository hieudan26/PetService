...
public class EmailServiceImpl implements EmailService {
    ...
    public String templateRegisterMessage(UserEntity user) {
        String token = jwtUtils.generateEmailJwtToken(user.getUserName());
        String validationLink = host+"confirm-email/="+token;
    ...
    public String templateForgetPasswordMessage(UserEntity user, String newpassord) {
        String username = user.getUserName();
        String text="<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">\n" +
                "<head>\n" +
